...
export function runH4FinalDecision(root = process.cwd()) {
  ...
  const decision = law.decision === 'AUTHORIZE_H4_COMPLETE' ? 'SAFE_TO_COMPLETE_H4' : 'KEEP_H4_ACTIVE';
  ...
  writeJson(root, '.stealtheye/state/h4-final-decision-next-actions.json', { next_actions: decision === 'SAFE_TO_COMPLETE_H4' ? ['prepare-h4-complete-updates'] : ['resolve-blockers', 'rerun-final-law'] });
