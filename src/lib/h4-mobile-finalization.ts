...
export function runH4MobileFinalization(root=process.cwd()){
  ...
  const out={phase:'H4',h4_status:'ACTIVE',timestamp:ctx.now,ultra_compact:true,next_action:'run h4:end-to-end-proof then h4:gap-reducer',branch:'h4/autonomy-continuity-fresh-tab-runtime',pr_posture:'open',approval_boundary:'explicit',blockers:['end-to-end-burnin','serialization-stability'],completion_readiness_posture:'not-ready'};
